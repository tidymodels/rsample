...
#' @export
vec_ptype2.group_mc_cv.group_mc_cv <- function(
  x,
  y,
  ...,
  x_arg = "",
...
#' @export
vec_ptype2.group_mc_cv.data.frame <- function(
  x,
  y,
  ...,
  x_arg = "",
...
#' @export
vec_ptype2.data.frame.group_mc_cv <- function(
  x,
  y,
  ...,
  x_arg = "",
...
#' @export
vec_cast.group_mc_cv.group_mc_cv <- function(
  x,
  to,
  ...,
  x_arg = "",
...
#' @export
vec_cast.group_mc_cv.data.frame <- function(
  x,
  to,
  ...,
  x_arg = "",
...
#' @export
vec_cast.data.frame.group_mc_cv <- function(
  x,
  to,
  ...,
  x_arg = "",
