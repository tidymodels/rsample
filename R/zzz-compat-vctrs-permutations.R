...
#' @export
vec_restore.permutations <- function(x, to, ...) {
...
#' @export
vec_ptype2.permutations.permutations <- function(
  x,
  y,
  ...,
  x_arg = "",
  ...
  stop_never_called("vec_ptype2.permutations.permutations")
}
#' @export
vec_ptype2.permutations.tbl_df <- function(x, y, ..., x_arg = "", y_arg = "") {
  stop_never_called("vec_ptype2.permutations.tbl_df")
}
#' @export
vec_ptype2.tbl_df.permutations <- function(x, y, ..., x_arg = "", y_arg = "") {
  stop_never_called("vec_ptype2.tbl_df.permutations")
}
#' @export
vec_ptype2.permutations.data.frame <- function(
  x,
  y,
  ...,
  x_arg = "",
  ...
  stop_never_called("vec_ptype2.permutations.data.frame")
}
#' @export
vec_ptype2.data.frame.permutations <- function(
  x,
  y,
  ...,
  x_arg = "",
  ...
  stop_never_called("vec_ptype2.data.frame.permutations")
}
...
#' @export
vec_cast.permutations.permutations <- function(
  x,
  to,
  ...,
  x_arg = "",
...
#' @export
vec_cast.permutations.tbl_df <- function(x, to, ..., x_arg = "", to_arg = "") {
  stop_incompatible_cast_rset(x, to, x_arg = x_arg, to_arg = to_arg)
}
#' @export
vec_cast.tbl_df.permutations <- function(x, to, ..., x_arg = "", to_arg = "") {
  tib_cast(x, to, ..., x_arg = x_arg, to_arg = to_arg)
}
#' @export
vec_cast.permutations.data.frame <- function(
  x,
  to,
  ...,
  x_arg = "",
...
#' @export
vec_cast.data.frame.permutations <- function(
  x,
  to,
  ...,
  x_arg = "",
