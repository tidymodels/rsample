...
#' @export
vec_ptype2.validation_split.validation_split <- function(
  x,
  y,
  ...,
  x_arg = "",
...
#' @export
vec_ptype2.validation_split.tbl_df <- function(
  x,
  y,
  ...,
  x_arg = "",
...
#' @export
vec_ptype2.tbl_df.validation_split <- function(
  x,
  y,
  ...,
  x_arg = "",
...
#' @export
vec_ptype2.validation_split.data.frame <- function(
  x,
  y,
  ...,
  x_arg = "",
...
#' @export
vec_ptype2.data.frame.validation_split <- function(
  x,
  y,
  ...,
  x_arg = "",
...
#' @export
vec_cast.validation_split.validation_split <- function(
  x,
  to,
  ...,
  x_arg = "",
...
#' @export
vec_cast.validation_split.tbl_df <- function(
  x,
  to,
  ...,
  x_arg = "",
...
#' @export
vec_cast.tbl_df.validation_split <- function(
  x,
  to,
  ...,
  x_arg = "",
...
#' @export
vec_cast.validation_split.data.frame <- function(
  x,
  to,
  ...,
  x_arg = "",
...
#' @export
vec_cast.data.frame.validation_split <- function(
  x,
  to,
  ...,
  x_arg = "",
