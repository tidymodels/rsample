...
#' @export
vec_ptype2.validation_time_split.validation_time_split <- function(
  x,
  y,
  ...,
  x_arg = "",
...
#' @export
vec_ptype2.validation_time_split.tbl_df <- function(
  x,
  y,
  ...,
  x_arg = "",
...
#' @export
vec_ptype2.tbl_df.validation_time_split <- function(
  x,
  y,
  ...,
  x_arg = "",
...
#' @export
vec_ptype2.validation_time_split.data.frame <- function(
  x,
  y,
  ...,
  x_arg = "",
...
#' @export
vec_ptype2.data.frame.validation_time_split <- function(
  x,
  y,
  ...,
  x_arg = "",
...
#' @export
vec_cast.validation_time_split.validation_time_split <- function(
  x,
  to,
  ...,
  x_arg = "",
...
#' @export
vec_cast.validation_time_split.tbl_df <- function(
  x,
  to,
  ...,
  x_arg = "",
...
#' @export
vec_cast.tbl_df.validation_time_split <- function(
  x,
  to,
  ...,
  x_arg = "",
...
#' @export
vec_cast.validation_time_split.data.frame <- function(
  x,
  to,
  ...,
  x_arg = "",
...
#' @export
vec_cast.data.frame.validation_time_split <- function(
  x,
  to,
  ...,
  x_arg = "",
