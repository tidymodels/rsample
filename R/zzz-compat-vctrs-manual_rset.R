...
#' @export
vec_ptype2.manual_rset.manual_rset <- function(
  x,
  y,
  ...,
  x_arg = "",
...
#' @export
vec_ptype2.manual_rset.data.frame <- function(
  x,
  y,
  ...,
  x_arg = "",
...
#' @export
vec_ptype2.data.frame.manual_rset <- function(
  x,
  y,
  ...,
  x_arg = "",
...
#' @export
vec_cast.manual_rset.manual_rset <- function(
  x,
  to,
  ...,
  x_arg = "",
...
#' @export
vec_cast.manual_rset.data.frame <- function(
  x,
  to,
  ...,
  x_arg = "",
...
#' @export
vec_cast.data.frame.manual_rset <- function(
  x,
  to,
  ...,
  x_arg = "",
