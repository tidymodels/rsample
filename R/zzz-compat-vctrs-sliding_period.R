...
#' @export
vec_ptype2.sliding_period.sliding_period <- function(
  x,
  y,
  ...,
  x_arg = "",
...
#' @export
vec_ptype2.sliding_period.tbl_df <- function(
  x,
  y,
  ...,
  x_arg = "",
...
#' @export
vec_ptype2.tbl_df.sliding_period <- function(
  x,
  y,
  ...,
  x_arg = "",
...
#' @export
vec_ptype2.sliding_period.data.frame <- function(
  x,
  y,
  ...,
  x_arg = "",
...
#' @export
vec_ptype2.data.frame.sliding_period <- function(
  x,
  y,
  ...,
  x_arg = "",
...
#' @export
vec_cast.sliding_period.sliding_period <- function(
  x,
  to,
  ...,
  x_arg = "",
...
#' @export
vec_cast.sliding_period.tbl_df <- function(
  x,
  to,
  ...,
  x_arg = "",
...
#' @export
vec_cast.tbl_df.sliding_period <- function(
  x,
  to,
  ...,
  x_arg = "",
...
#' @export
vec_cast.sliding_period.data.frame <- function(
  x,
  to,
  ...,
  x_arg = "",
...
#' @export
vec_cast.data.frame.sliding_period <- function(
  x,
  to,
  ...,
  x_arg = "",
