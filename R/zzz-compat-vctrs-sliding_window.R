...
#' @export
vec_ptype2.sliding_window.sliding_window <- function(
  x,
  y,
  ...,
  x_arg = "",
...
#' @export
vec_ptype2.sliding_window.tbl_df <- function(
  x,
  y,
  ...,
  x_arg = "",
...
#' @export
vec_ptype2.tbl_df.sliding_window <- function(
  x,
  y,
  ...,
  x_arg = "",
...
#' @export
vec_ptype2.sliding_window.data.frame <- function(
  x,
  y,
  ...,
  x_arg = "",
...
#' @export
vec_ptype2.data.frame.sliding_window <- function(
  x,
  y,
  ...,
  x_arg = "",
...
#' @export
vec_cast.sliding_window.sliding_window <- function(
  x,
  to,
  ...,
  x_arg = "",
...
#' @export
vec_cast.sliding_window.tbl_df <- function(
  x,
  to,
  ...,
  x_arg = "",
...
#' @export
vec_cast.tbl_df.sliding_window <- function(
  x,
  to,
  ...,
  x_arg = "",
...
#' @export
vec_cast.sliding_window.data.frame <- function(
  x,
  to,
  ...,
  x_arg = "",
...
#' @export
vec_cast.data.frame.sliding_window <- function(
  x,
  to,
  ...,
  x_arg = "",
