...
#' @export
vec_ptype2.group_bootstraps.group_bootstraps <- function(
  x,
  y,
  ...,
  x_arg = "",
...
#' @export
vec_ptype2.group_bootstraps.tbl_df <- function(
  x,
  y,
  ...,
  x_arg = "",
...
#' @export
vec_ptype2.tbl_df.group_bootstraps <- function(
  x,
  y,
  ...,
  x_arg = "",
...
#' @export
vec_ptype2.group_bootstraps.data.frame <- function(
  x,
  y,
  ...,
  x_arg = "",
...
#' @export
vec_ptype2.data.frame.group_bootstraps <- function(
  x,
  y,
  ...,
  x_arg = "",
...
#' @export
vec_cast.group_bootstraps.group_bootstraps <- function(
  x,
  to,
  ...,
  x_arg = "",
...
#' @export
vec_cast.group_bootstraps.tbl_df <- function(
  x,
  to,
  ...,
  x_arg = "",
...
#' @export
vec_cast.tbl_df.group_bootstraps <- function(
  x,
  to,
  ...,
  x_arg = "",
...
#' @export
vec_cast.group_bootstraps.data.frame <- function(
  x,
  to,
  ...,
  x_arg = "",
...
#' @export
vec_cast.data.frame.group_bootstraps <- function(
  x,
  to,
  ...,
  x_arg = "",
