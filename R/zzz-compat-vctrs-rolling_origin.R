...
#' @export
vec_ptype2.rolling_origin.rolling_origin <- function(
  x,
  y,
  ...,
  x_arg = "",
...
#' @export
vec_ptype2.rolling_origin.tbl_df <- function(
  x,
  y,
  ...,
  x_arg = "",
...
#' @export
vec_ptype2.tbl_df.rolling_origin <- function(
  x,
  y,
  ...,
  x_arg = "",
...
#' @export
vec_ptype2.rolling_origin.data.frame <- function(
  x,
  y,
  ...,
  x_arg = "",
...
#' @export
vec_ptype2.data.frame.rolling_origin <- function(
  x,
  y,
  ...,
  x_arg = "",
...
#' @export
vec_cast.rolling_origin.rolling_origin <- function(
  x,
  to,
  ...,
  x_arg = "",
...
#' @export
vec_cast.rolling_origin.tbl_df <- function(
  x,
  to,
  ...,
  x_arg = "",
...
#' @export
vec_cast.tbl_df.rolling_origin <- function(
  x,
  to,
  ...,
  x_arg = "",
...
#' @export
vec_cast.rolling_origin.data.frame <- function(
  x,
  to,
  ...,
  x_arg = "",
...
#' @export
vec_cast.data.frame.rolling_origin <- function(
  x,
  to,
  ...,
  x_arg = "",
