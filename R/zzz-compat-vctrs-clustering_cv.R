...
#' @export
vec_restore.clustering_cv <- function(x, to, ...) {
...
#' @export
vec_ptype2.clustering_cv.tbl_df <- function(x, y, ..., x_arg = "", y_arg = "") {
  stop_never_called("vec_ptype2.clustering_cv.tbl_df")
}
#' @export
vec_ptype2.tbl_df.clustering_cv <- function(x, y, ..., x_arg = "", y_arg = "") {
...
#' @export
vec_cast.clustering_cv.tbl_df <- function(x, to, ..., x_arg = "", to_arg = "") {
  stop_incompatible_cast_rset(x, to, x_arg = x_arg, to_arg = to_arg)
}
#' @export
vec_cast.tbl_df.clustering_cv <- function(x, to, ..., x_arg = "", to_arg = "") {
