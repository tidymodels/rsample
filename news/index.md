...
- The new
  [`internal_calibration_split()`](https://rsample.tidymodels.org/reference/internal_calibration_split.md)
...
- New accessor function
  [`calibration()`](https://rsample.tidymodels.org/reference/internal_calibration_split.md)
...
- Bootstrap intervals via
  ...
  [`int_t()`](https://rsample.tidymodels.org/reference/int_pctl.md), and
...
- The deprecation of
  [`validation_split()`](https://rsample.tidymodels.org/reference/validation_split.md),
  [`validation_time_split()`](https://rsample.tidymodels.org/reference/validation_split.md),
  and
  [`group_validation_split()`](https://rsample.tidymodels.org/reference/validation_split.md)
...
- Removed trailing space in printing of
  [`mc_cv()`](https://rsample.tidymodels.org/reference/mc_cv.md) objects
