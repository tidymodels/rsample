...
first_resample
```
This indicates that there were `r dim(splits(bt_resamples, .elem = "splits")[[1]])["analysis"]` data points in the analysis set, `r dim(splits(bt_resamples, .elem = "splits")[[1]])["assessment"]` instances were in the assessment set, and that the original data contained `r dim(splits(bt_resamples, .elem = "splits")[[1]])["n"]` data points. The can also be determined using the `dim` function on an `rsplit` object. 
