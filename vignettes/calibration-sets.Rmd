...
Crucial: To avoid overfitting, we cannot use the same data to fit our calibration model as we use to assess the combination of prediction and calibration model. Using the same data to fit the prediction model and the calibration model also risks overfitting the calibration model.
